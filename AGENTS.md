...
- Prefer UnoCSS utilities and theme tokens (`text-primary`, `bg-bg-1`, `border-default`) over ad-hoc inline styles; align with the green `primary` palette defined in `unocss.config.ts`.
